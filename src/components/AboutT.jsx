...
const AboutT = ({ darkMode }) => {
    ...
    return (
        <div id="about" ref={ref2} className='pb-[120px] min-w-screen overflow-x-hidden overflow-hidden flex justify-center dark:bg-black bg-[#F4F4F4]'>
                        ...
                        <div className='h-[300px] w-full flex mt-[50px] items-start md:flex-row flex-col'>
                            ...
                            <div className='h-full w-[300px] flex md:flex-row md:justify-end mb-auto items-end mr-[50px] lg:mr-[100px]'>
                                <a href='https://www.linkedin.com/in/dangoliveira/' target='blank' className='mr-[40px] dark:block hidden'>
                                    <img id="myImage" className='hover:scale-105 sm:w-[100px] sm:h-[100px] w-[70px] h-[70px]' src="linkedlogodark.png" alt="linkedinLOGOD.png" />
                                </a>
                                <a href='https://www.linkedin.com/in/dangoliveira/' target='blank' className='mr-[40px] dark:hidden dark'>
                                    <img id="myImage" className='hover:scale-105 sm:w-[100px] sm:h-[100px] w-[70px] h-[70px]' src="hyped.png" alt="linkedinLOGOD.png" />
                                </a>
                                <a href='https://github.com/GriDaniel' target='blank' className='dark:block hidden'>
                                    <img className='hover:scale-105 sm:w-[100px] sm:h-[100px] w-[70px] h-[70px]' src="gitPANG.png" alt="" />
                                </a>
                                <a href='https://github.com/GriDaniel' target='blank' className='dark:hidden block'>
                                    <img className='hover:scale-105 rounded-full sm:w-[100px] sm:h-[100px] w-[70px] h-[70px]' src="POSSIBLE.png" alt="" />
                                </a>
                            </div>
                        </div>
                    </div>
