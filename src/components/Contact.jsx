...
function Contact() {
    return (
        <div id="contact" className='pt-[200px] pb-[25px] min-w-screen min-h-[300px] overflow-x-hidden overflow-hidden flex dark:bg-black flex-row bg-[#F4F4F4]'>
            ...
            <div className='max:w-[1920px]  w-screen min-h-[250px]  flex items-center justify-center md:flex-row flex-col'>
                <div className='md:w-[50%]  w-[85%] h-full flex justify-center items-center'>
                    <div className='min-h-[80%] md:w-[40%] w-full dark:text-white text-black'>
                        ...
                        <p className='mt-[60px]'> © 2024 All Rights Reserved.</p>
                    </div>
                </div>
                <div className='w-[50%] md:mt-0 mt-[75px] h-full flex flex-row justify-center'>
                    <div className='h-full w-[50%] flex flex-row md:justify-end justify-center'>
